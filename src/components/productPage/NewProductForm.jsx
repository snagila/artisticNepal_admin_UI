...
const NewProductForm = ({ productData }) => {
  const { _id, uploadedImages, ...rest } = productData;
  ...
  const buttonText = _id ? "Update" : "Create";
  ...
  const handleOnSubmit = async (e) => {
    ...
    if (_id) {
      ...
      dispatch(editProductAction(formObject, _id, existingImages));
    }
  };
